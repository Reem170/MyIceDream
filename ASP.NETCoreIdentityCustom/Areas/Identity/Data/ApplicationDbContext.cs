...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser, IdentityRole, string>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Product>().HasData(
           ...
           new Product { Id = 5, Name = "Kunafa nabelssia med ost", Price = 50m, CategoryId = 1, Availability = true, Image = "/images/NoImage.jpeg" },
           ...
           new Product { Id = 8, Name = "Baklava mix", Price = 50m, CategoryId = 1, Availability = true, Image = "/images/Baklawa.png" },
           ...
           new Product { Id = 11, Name = "Bubble waffle med nutella og is", Price = 65m, CategoryId = 1, Availability = true, Image = "/images/BubbleWaffleIs.png" },
           ...
           new Product { Id = 13, Name = "Belgisk waffle", Price = 50m, CategoryId = 1, Availability = true, Image = "/images/NoImage.jpeg" },
...
// Is
new Product { Id = 23, Name = "Is box - 0.75 liter (3 smage)", Price = 115m, CategoryId = 2, Availability = true, Image = "/images/NoImage.jpeg" },
new Product { Id = 24, Name = "Is box - 1 liter (4 smage)", Price = 145m, CategoryId = 2, Availability = true, Image = "/images/NoImage.jpeg" },
new Product { Id = 25, Name = "Is box - 1.5 liter (5 smage)", Price = 190m, CategoryId = 2, Availability = true, Image = "/images/NoImage.jpeg" },
...
// Varm drikke
new Product { Id = 30, Name = "Americano", Price = 30m, CategoryId = 3, Availability = true, Image = "/images/Kaffe.png" },
new Product { Id = 31, Name = "Espresso", Price = 25m, CategoryId = 3, Availability = true, Image = "/images/NoImage.jpeg" },
new Product { Id = 32, Name = "Cappuccino", Price = 45m, CategoryId = 3, Availability = true, Image = "/images/NoImage.jpeg" },
...
new Product { Id = 35, Name = "Matcha latte", Price = 50m, CategoryId = 3, Availability = true, Image = "/images/NoImage.jpeg" },
...
new Product { Id = 44, Name = "Matcha", Price = 50m, CategoryId = 4, Availability = true, Image = "/images/NoImage.jpeg" },
new Product { Id = 45, Name = "Lemonade", Price = 45m, CategoryId = 4, Availability = true, Image = "/images/NoImage.jpeg" },
